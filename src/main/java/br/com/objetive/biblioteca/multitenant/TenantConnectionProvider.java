...
import br.com.objetive.biblioteca.config.FlywayConfig;

@Component
public class TenantConnectionProvider implements org.hibernate.engine.jdbc.connections.spi.MultiTenantConnectionProvider {
    ...
    private String PUBLIC_TENANT = FlywayConfig.PUBLIC_SCHEMA;
    ...
    public void releaseConnection(String tenantIdentifier, Connection connection) throws SQLException {
        ...
        connection.setSchema(PUBLIC_TENANT);
